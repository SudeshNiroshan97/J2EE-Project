<%-- 
    ...
    Created on : Mar 29, 2019, 10:54:21 PM
            ...
            <div class="main-panel" id="main-panel">
                ...
                <div class="content">
                    ...
                    try
                    {
                        ...
                        PreparedStatement pst = connection.prepareStatement(" SELECT * FROM student where email='"+email+"'");
                        ResultSet rs = pst.executeQuery();
                        while(rs.next())
                        {
                           String frist_name = rs.getString("frist_name");
                           ...
                           request.setAttribute("frist_name", frist_name);
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled="" value='${frist_name}' >
                                            </div>
                                        </div>
                                        <div class="col-md-5 pr-1">
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input type="text" class="form-control" disabled="" value='${last_name}'  >
                                            </div>
                                        </div>
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email address</label>
                                                <input type="email" class="form-control" placeholder="Email" disabled="" value='${email}'>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled="" value='${university}'>
                                            </div>
                                        </div>
                                   ...
                                   <!-- <div class="row">
                                        ...
                                        <div class="col-md-4 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled="" value='${phonenumber}'>
                                            </div>
                                        </div>
